...
export const ScoutRecommendation = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#00B365" }}>
      <ScrollView>
        <Image
          className="self-center top-5"
          source={require("../../assets/scoutreco.png")}
          style={{ width: 210, height: 200 }}
        />

        <View
          className="px-8 pt-8 bg-white top-9 "
          style={{
        ...
        >
          ...
          <TextInput
            className="py-3  top-1 text-gray-700 rounded-2xl"
          ...
          <TextInput
            className="p-3 top-1 text-gray-700 rounded-2xl"
          ...
          <TouchableOpacity onPress={handleGetRecommendations}>
            <Text className="self-center   rounded-3xl" style={styles.Button2}>
              Get Recommendations
            </Text>
          </TouchableOpacity>
        </View>
          ...
          <View style={{ backgroundColor: "white", width: "100%", flex: 1 }}>
            {recommendations.map((player, index) => (
              <View key = {index.toString()}>
                ...
                <Text className="font-bold left-24 bottom-7 ">
                  {player.fullName}
                  {"\n"}
                  {player.position}
                </Text>
                ...
                >
                  <View style={styles.inputContainer}>
                    <Text className=" text-center  pb-2 font-bold" key={index}>
                      Age
                    </Text>
